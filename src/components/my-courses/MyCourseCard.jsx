  ...
  return (
    <Card className="flex flex-col h-full border-0 shadow-lg bg-white/80 backdrop-blur-sm">
      ...
      <CardContent className="p-3 md:p-4 flex-grow">
        ...
        <p className="text-xs md:text-sm text-slate-500 line-clamp-2">{course.description}</p>
      </CardContent>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem asChild>
              <Link to={createPageUrl(`CourseEditor?id=${course.id}`)} className="flex items-center gap-2 w-full cursor-pointer text-xs md:text-sm">
