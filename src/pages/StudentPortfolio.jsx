...
import SkillMasteryRings from '@/components/portfolio/SkillMasteryRings';
      ...
      <main className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="link" className="text-purple-400 text-sm">View Roadmap</Button>
          </div>
          
          <SkillMasteryRings skills={skillMastery.map(s => ({
            skill: s.skill,
            level: s.level,
            color: s.color === 'cyan' ? '#00f2ff' : s.color === 'magenta' ? '#ff00ff' : '#137fec',
